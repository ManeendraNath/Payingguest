jQuery(document).ready(function()
{
	...
	{	
		// jQuery(".type-of-benefits .radio-inline").removeAttr('disabled');
		...
		//var agency_regex =/^[a-zA-Z0-9&-_() ]+$/;
                var agency_regex =/^[a-zA-Z0-9\~\`\!\@\#\$\%\^\*\(\)\-\_\=\{\}\[\]\|\:\;\"\'\,\.\?\/\n ]+$/;
                var specificreason_regex =/^[a-zA-Z0-9\~\`\!\@\#\$\%\^\*\(\)\-\_\=\{\}\[\]\|\:\;\"\'\,\.\?\/\n ]+$/;
		//var agency_regex = <?php echo TEXTJS; ?>; 
		//alert(agency_regex);
		...
		else if(!target.match(agency_regex))
   	        {
		...
		else if(!scheme.match(specificreason_regex)) 
		{
